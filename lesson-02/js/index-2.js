...
// 2. перевірити дані
// 3. Якщо вірні дані, вивести в консоль рядок Правильно!
// 4. Якщо дані невірні, вивести в консоль рядок Не знаєте? ECMAScript
...
// }else{
//     alert(`користувач натиснув "скасувати"`); 
// }
...
// let link = 'https://somesite.com/about';
// link = (link += '/') ? link.includes('my-site') : !link.endsWith('/');
// console.log(link);
