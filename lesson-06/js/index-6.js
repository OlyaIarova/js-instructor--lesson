...
// ],
// };
// const {activities: [firstActivities]} = obj;
// console.log(firstActivities); // вивести першу позицію з масиву 'fly'

// const {activities: [ , secondActivities ]} = obj;
// console.log(secondActivities); // вивести другу позицію з масиву 'play'

// const {dress:{pents: favouritePents }} = obj;
// console.log(favouritePents); // перейменувати і вивести з об'єкту'Green Pents'

// const {dress: {boots: favouriteBoots = "crosses"}} = obj;
// console.log(favouriteBoots); // вивести з об'єкту неіснуючого значення "crosses"

// const {jobs: [{ offices: [{ location: officesLocation }] }] } = obj;
// console.log(officesLocation); // вивести з масиву об'єкт який знаходиться в об'єкті 'Kyiv'

// const {jobs: [{ offices: [office1], },], } = obj;
// const office1Copy = {...office1, location: 'Ukraine'};
// console.log(office1Copy); //добавити офіс 1 'Ukraine'